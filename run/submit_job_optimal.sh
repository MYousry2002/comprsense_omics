...
#$ -N simulation_optimal
#$ -l h_rt=12:00:00       # Request 12 hours runtime
#$ -pe omp 32             # Request 18 cores per node
#$ -t 1-24            # Run 300 parallel jobs
#$ -o /projectnb/cisi/myousry/comprsense_omics/logs/simulation_optimal.log
#$ -e /projectnb/cisi/myousry/comprsense_omics/logs/simulation_optimal.err
