...
#$ -o /projectnb/cisi/myousry/comprsense_omics/logs/optimization/pools_simulation.log
#$ -e /projectnb/cisi/myousry/comprsense_omics/logs/optimization/pools_simulation.err
