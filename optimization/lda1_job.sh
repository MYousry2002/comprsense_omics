...
#$ -o /projectnb/cisi/myousry/comprsense_omics/logs/optimization/lda1_simulation.log
#$ -e /projectnb/cisi/myousry/comprsense_omics/logs/optimization/lda1_simulation.err
