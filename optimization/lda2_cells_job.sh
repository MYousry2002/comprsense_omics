...
#$ -N lda2_cells_experiment
#$ -l h_rt=4:00:00       # Request 12 hours runtime
#$ -pe omp 32             # Request 32 cores per node
#$ -t 1-50            # Run 24 parallel jobs
#$ -o /projectnb/cisi/myousry/comprsense_omics/logs/optimization/lda2_cells_experiment.log
#$ -e /projectnb/cisi/myousry/comprsense_omics/logs/optimization/lda2_cells_experiment.err
...
python lda2_cells_experiment.py