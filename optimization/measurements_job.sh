...
#$ -N measurements_simulation
#$ -l h_rt=4:00:00       # Request 12 hours runtime
#$ -pe omp 32             # Request 32 cores per node
#$ -t 1-24            # Run 24 parallel jobs
#$ -o /projectnb/cisi/myousry/comprsense_omics/logs/optimization/measurements_simulation.log
#$ -e /projectnb/cisi/myousry/comprsense_omics/logs/optimization/measurements_simulation.err
...
python measurements_experiment.py