...
lda2 = 10.0  # Keeping lda2 fixed
sparsity = 0.02
num_repeats = 10  # Ensure each parameterization runs multiple times

# Define parameter search space (Varying lda1 and num_cells)
lda1_values = [2, 4, 8, 12, 16, 20]  # 6 values
num_cells_values = [1000, 10000, 20000, 50000, 75000, 100000]  # 6 values

# Generate all parameter combinations
parameter_combinations = [(lda1, num_cells) 
                          for lda1 in lda1_values
...
lda1, num_cells = parameter_combinations[job_id]
print(f"Running simulation with: num_cells={num_cells}, lda1={lda1}, num_measurements={num_measurements}, gene_set_size={gene_set_size}, lda2={lda2}, sparsity={sparsity}")
...
csv_path = "output/lda1_cells_experiment.csv"
